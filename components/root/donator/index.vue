      ...
      <a-row>
        <a-col :md="10">
          <div class="home-tab"> 
            ...
            <a
              href="javascript:;"
              @click="handleSidebarKey(`/donator/samples`, 2)"
            >
              <h4 class="heading-home">
                <strong class="strong"> My Samples </strong>
              </h4>
            </a>
          </div>
          ...
          <div class="home-tab">
            ...
            <a
              href="javascript:;"
              @click="handleSidebarKey(`/donator/documents`, 4)"
            >
              <h4 class="heading-home">
                <strong class="strong"> My Document  <span class="color-red">{{ message }}</span></strong>
              </h4>
            </a>
          </div>
        </a-col>
        ...
        <a-col :md="10">
          <div class="home-tab">
            ...
            <a
              href="javascript:;"
              @click="handleSidebarKey(`/donator/studies`, 3)"
            >
              <h4 class="heading-home">
                <strong class="strong">My Studies</strong>
              </h4>
            </a>
          </div>
          ...
          <div class="home-tab">
            ...
            <a
              href="javascript:;"
              @click="handleSidebarKey(`/donator/institutions`, 5)"
            >
              <h4 class="heading-home">
                <strong class="strong">Institutions</strong>
              </h4>
            </a>
          </div>
        </a-col>
