<template>
    ...
    :loading="false"
      ...
      <template slot="projectStatus" slot-scope="projectStatus">
        <span >
                <a :style="{'color': projectStatus.projectStatus === pending && userRole === roleUsers.manager_type.name ? 'red' : 'blue'}"  >{{
      ...
      <template slot="projectDate" slot-scope="data">
        ...
        <template slot="processStatus"  slot-scope="processStatus">
          <span :style="{'color': processStatus.processStatus === pending && userRole === roleUsers.manager_type.name ? 'red' : 'blue'}" >
