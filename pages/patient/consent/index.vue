<template>
    ...
    <div slot="content">
        ...
        <template slot="action" slot-scope="text,record">
            <template v-for="status in documents">
                <a-tooltip placement="topLeft" :key="status.value">
                    <template slot="title">
        ...
        <h2>Your sample helps us make great progress in this research! 
            ...
            <hr/>
            <template>
                    <center> <a-button type="primary" @click="WithDrawDocuments(true,withdraw24Hour)">
                Yes, I need 24 hours
                </a-button>
...
export default({
    ...
    methods:{
        getStudies(email){
            ...
            // const mail = JSON.parse(JSON.stringify(email))
        ...
        WithDrawDocuments(toDecide,status){
            ...
            formData.append('PConsentId',this.currentData.projectConsentId)
            ...
            }).catch(this.error).finally(this.visibleModal(false))
        },
